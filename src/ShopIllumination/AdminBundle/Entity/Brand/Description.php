...
use ShopIllumination\AdminBundle\Entity\DescriptionInterface;
...
class Description implements DescriptionInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Brand", inversedBy="descriptions")
     */
    private $brand;

	/**
     * @ORM\OneToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Image")
     ...
     * Set logoImage
     *
     * @param \ShopIllumination\AdminBundle\Entity\Image $logoImage
     * @return Description
     */
    public function setLogoImage(\ShopIllumination\AdminBundle\Entity\Image $logoImage = null)
    {
     ...
     * Get logoImage
     *
     * @return \ShopIllumination\AdminBundle\Entity\Image
     */
