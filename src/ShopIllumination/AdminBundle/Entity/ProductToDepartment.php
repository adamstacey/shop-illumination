...
class ProductToDepartment
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Product", inversedBy="departments")
     * @Assert\NotBlank()
     * @Assert\NotNull()
     **/
    private $product;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Department")
