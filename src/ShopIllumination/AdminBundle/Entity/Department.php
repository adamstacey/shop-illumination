...
class Department implements DescribableInterface
{
    ...
    /**
     * @Gedmo\TreeParent
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Department", inversedBy="children")
     * @ORM\JoinColumn(name="parent_id", referencedColumnName="id", onDelete="SET NULL")
     */
    private $parent;

    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Department", mappedBy="parent")
     * @ORM\OrderBy({"lft" = "ASC"})
     */
    private $children;
     ...
     * @return Department
     */
    public function setParent(\ShopIllumination\AdminBundle\Entity\Department $parent = null)
    {
        $this->parent = $parent;
     ...
     * @return Department
     */
    public function addChildren(\ShopIllumination\AdminBundle\Entity\Department $children)
    {
