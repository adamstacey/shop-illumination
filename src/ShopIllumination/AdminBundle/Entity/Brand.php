...
class Brand
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Brand\Description", mappedBy="brand", cascade={"all"})
     * @ORM\JoinColumn(onDelete="CASCADE")
     */
    private $descriptions;

    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\BrandToDepartment", mappedBy="brand", cascade={"all"})
     * @ORM\JoinColumn(onDelete="CASCADE")
     **/
    private $departments;

    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Brand\Routing", mappedBy="brand", cascade={"all"})
     * @ORM\JoinColumn(onDelete="CASCADE")
     */
    private $routings;

    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Brand\Image", mappedBy="brand", cascade={"all"})
     * @ORM\JoinColumn(onDelete="CASCADE")
     */
    private $images;

    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Brand\Document", mappedBy="brand", cascade={"all"})
     * @ORM\JoinColumn(onDelete="CASCADE")
     */
    private $documents;
     ...
     * Add departments
     *
     * @param \ShopIllumination\AdminBundle\Entity\BrandToDepartment $departments
     * @return Brand
     */
    public function addDepartment(\ShopIllumination\AdminBundle\Entity\BrandToDepartment $departments)
    {
     ...
     * @param \ShopIllumination\AdminBundle\Entity\BrandToDepartment $departments
     */
    public function removeDepartment(\ShopIllumination\AdminBundle\Entity\BrandToDepartment $departments)
    {
     ...
     * Add descriptions
     *
     * @param \ShopIllumination\AdminBundle\Entity\Brand\Description $descriptions
     * @return Brand
     */
     ...
     * Add images
     *
     * @param \ShopIllumination\AdminBundle\Entity\Brand\Image $images
     * @return Brand
     */
    public function addImage(\ShopIllumination\AdminBundle\Entity\Brand\Image $images)
    {
        $this->images[] = $images;
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Brand\Image $images
     */
    public function removeImage(\ShopIllumination\AdminBundle\Entity\Brand\Image $images)
    {
     ...
     * Add documents
     *
     * @param \ShopIllumination\AdminBundle\Entity\Brand\Document $documents
     * @return Brand
     */
    public function addDocument(\ShopIllumination\AdminBundle\Entity\Brand\Document $documents)
    {
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Brand\Document $documents
     */
    public function removeDocument(\ShopIllumination\AdminBundle\Entity\Brand\Document $documents)
    {
     ...
     * Add routings
     *
     * @param \ShopIllumination\AdminBundle\Entity\Brand\Routing $routings
     * @return Brand
     */
    public function addRouting(\ShopIllumination\AdminBundle\Entity\Brand\Routing $routings)
    {
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Brand\Routing $routings
     */
    public function removeRouting(\ShopIllumination\AdminBundle\Entity\Brand\Routing $routings)
    {
