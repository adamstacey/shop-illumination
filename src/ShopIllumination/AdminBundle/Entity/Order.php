...
/**
 * @ORM\Entity(repositoryClass="ShopIllumination\AdminBundle\Repository\OrderRepository")
...
class Order
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Order\Discount", mappedBy="order")
     */
    private $discounts;

    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Order\Donation", mappedBy="order")
     */
    private $donations;

    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Order\Product", mappedBy="order")
     */
    private $products;

    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Order\Note", mappedBy="order")
     */
    private $notes;
    ...
    public function getPaymentTypeLogo()
    {
    	...
    	{
    		case 'SagePay':
    			return 'bundles/shopilluminationadmin/images/logos/sage-pay-small.png';
    		case 'PayPal through SagePay':
    			return 'bundles/shopilluminationadmin/images/logos/pay-pal-through-sage-pay-small.png';
    		case 'PayPal':
    			return 'bundles/shopilluminationadmin/images/logos/pay-pal-small.png';
    		case 'Google Wallet':
    			return 'bundles/shopilluminationadmin/images/logos/google-wallet-small.png';
    		case 'Voucher Code':
    			return 'bundles/shopilluminationadmin/images/logos/voucher-code-small.png';
    		case 'Gift Voucher':
    			return 'bundles/shopilluminationadmin/images/logos/gift-voucher-small.png';
    	}
        return '';
    }
    ...
    public function getPaymentResponseFraudIcon()
    {
        ...
        return 'bundles/shopilluminationadmin/images/icons/'.$iconColour.'-light-icon.png';
    }
     ...
     * Add discounts
     *
     * @param \ShopIllumination\AdminBundle\Entity\Order\Discount $discounts
     * @return Order
     */
    public function addDiscount(\ShopIllumination\AdminBundle\Entity\Order\Discount $discounts)
    {
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Order\Discount $discounts
     */
    public function removeDiscount(\ShopIllumination\AdminBundle\Entity\Order\Discount $discounts)
    {
     ...
     * Add donations
     *
     * @param \ShopIllumination\AdminBundle\Entity\Order\Donation $donations
     * @return Order
     */
    public function addDonation(\ShopIllumination\AdminBundle\Entity\Order\Donation $donations)
    {
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Order\Donation $donations
     */
    public function removeDonation(\ShopIllumination\AdminBundle\Entity\Order\Donation $donations)
    {
     ...
     * Add products
     *
     * @param \ShopIllumination\AdminBundle\Entity\Order\Product $products
     * @return Order
     */
    public function addProduct(\ShopIllumination\AdminBundle\Entity\Order\Product $products)
    {
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Order\Product $products
     */
    public function removeProduct(\ShopIllumination\AdminBundle\Entity\Order\Product $products)
    {
     ...
     * Add notes
     *
     * @param \ShopIllumination\AdminBundle\Entity\Order\Note $notes
     * @return Order
     */
    public function addNote(\ShopIllumination\AdminBundle\Entity\Order\Note $notes)
    {
        $this->notes[] = $notes;
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Order\Note $notes
     */
    public function removeNote(\ShopIllumination\AdminBundle\Entity\Order\Note $notes)
    {
