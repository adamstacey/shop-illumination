<?php
namespace ShopIllumination\AdminBundle\Entity\Order;
...
class Product
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Order", inversedBy="products")
     */
    private $order;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Product", cascade={"detach"})
     * @ORM\JoinColumn(onDelete="SET NULL")
     */
    private $product;

    /**
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Product\Variant")
     * @ORM\JoinColumn(onDelete="SET NULL")
     */
    private $variant;
     ...
     * Set order
     *
     * @param \ShopIllumination\AdminBundle\Entity\Order $order
     * @return Product
     */
    public function setOrder(\ShopIllumination\AdminBundle\Entity\Order $order = null)
    {
        $this->order = $order;
     ...
     * Get order
     *
     * @return \ShopIllumination\AdminBundle\Entity\Order
     */
