...
class VariantToOption
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Product\Variant", inversedBy="options")
     */
    private $variant;

    /**
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Product\OptionGroup")
     * @ORM\JoinColumn(name="option_group_id", referencedColumnName="id")
     **/
    private $optionGroup;

    /**
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Product\Option")
    ...
    /**
     * @return \ShopIllumination\AdminBundle\Entity\Product\Option
     */
