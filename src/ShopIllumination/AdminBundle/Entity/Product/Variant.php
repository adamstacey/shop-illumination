...
use ShopIllumination\AdminBundle\Entity\Type;
...
class Variant implements DescribableInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Product", inversedBy="variants")
     * @var Product
     */
    private $product;

    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Product\Variant\Description", mappedBy="variant", cascade={"all"})
    ...
    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Product\VariantToFeature", mappedBy="variant", cascade={"all"})
     * @ORM\JoinColumn(onDelete="CASCADE")
    ...
    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Product\VariantToOption", mappedBy="variant", cascade={"all"})
     * @ORM\JoinColumn(onDelete="CASCADE")
     * @ORM\OrderBy({"displayOrder" = "ASC"})
     * @Assert\Valid()
     * @var VariantToOption[]
    ...
    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Product\Price", mappedBy="variant", cascade={"all"})
     * @ORM\JoinColumn(onDelete="CASCADE")
    ...
    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Product\Variant\Image", mappedBy="variant", cascade={"all"})
     * @ORM\JoinColumn(onDelete="CASCADE")
     * @var Variant\Image
     */
    private $images;
    ...
    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Product\Variant\Document", mappedBy="variant", cascade={"all"})
     * @ORM\JoinColumn(onDelete="CASCADE")
    ...
    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Product\Variant\Routing", mappedBy="variant", cascade={"all"})
     * @ORM\JoinColumn(onDelete="CASCADE")
     * @var Variant\Routing[]
     * @Assert\Valid()
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Product\Variant\Link", mappedBy="variant", cascade={"all"})
     * @ORM\JoinColumn(onDelete="CASCADE")
     * @var Link[]
     */
    private $links;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Type")
     * @var Type
     */
    private $type;
     ...
     * Add options
     *
     * @param \ShopIllumination\AdminBundle\Entity\Product\VariantToOption $options
     * @return Variant
     */
    public function addOption(\ShopIllumination\AdminBundle\Entity\Product\VariantToOption $options)
    {
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Product\VariantToOption $options
     */
    public function removeOption(\ShopIllumination\AdminBundle\Entity\Product\VariantToOption $options)
    {
     ...
     * Add features
     *
     * @param \ShopIllumination\AdminBundle\Entity\Product\VariantToFeature $features
     * @return Variant
     */
    public function addFeature(\ShopIllumination\AdminBundle\Entity\Product\VariantToFeature $features)
    {
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Product\VariantToFeature $features
     */
    public function removeFeature(\ShopIllumination\AdminBundle\Entity\Product\VariantToFeature $features)
    {
     ...
     * Add prices
     *
     * @param \ShopIllumination\AdminBundle\Entity\Product\Price $prices
     * @return Variant
     */
    public function addPrice(\ShopIllumination\AdminBundle\Entity\Product\Price $prices)
    {
        $this->prices[] = $prices;
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Product\Price $prices
     */
    public function removePrice(\ShopIllumination\AdminBundle\Entity\Product\Price $prices)
    {
     ...
     * Add descriptions
     *
     * @param \ShopIllumination\AdminBundle\Entity\Product\Variant\Description $descriptions
     * @return Variant
     */
    public function addDescription(\ShopIllumination\AdminBundle\Entity\Product\Variant\Description $descriptions)
    {
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Product\Variant\Description $descriptions
     */
    public function removeDescription(\ShopIllumination\AdminBundle\Entity\Product\Variant\Description $descriptions)
    {
     ...
     * Add routings
     *
     * @param \ShopIllumination\AdminBundle\Entity\Product\Variant\Routing $routings
     * @return Variant
     */
    public function addRouting(\ShopIllumination\AdminBundle\Entity\Product\Variant\Routing $routings)
    {
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Product\Variant\Routing $routings
     */
    public function removeRouting(\ShopIllumination\AdminBundle\Entity\Product\Variant\Routing $routings)
    {
     ...
     * Add images
     *
     * @param \ShopIllumination\AdminBundle\Entity\Product\Variant\Image $images
     * @return Variant
     */
    public function addImage(\ShopIllumination\AdminBundle\Entity\Product\Variant\Image $images)
    {
        $this->images[] = $images;
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Product\Variant\Image $images
     */
    public function removeImage(\ShopIllumination\AdminBundle\Entity\Product\Variant\Image $images)
    {
     ...
     * Add documents
     *
     * @param \ShopIllumination\AdminBundle\Entity\Product\Variant\Document $documents
     * @return Variant
     */
    public function addDocument(\ShopIllumination\AdminBundle\Entity\Product\Variant\Document $documents)
    {
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Product\Variant\Document $documents
     */
    public function removeDocument(\ShopIllumination\AdminBundle\Entity\Product\Variant\Document $documents)
    {
