...
class Description implements DescriptionInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Department", inversedBy="descriptions")
     */
    private $department;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Taxonomy")
