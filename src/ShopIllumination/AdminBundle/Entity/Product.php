...
class Product implements DescribableInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Brand")
    ...
    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Product\Description", mappedBy="product", cascade={"all"}, orphanRemoval=true)
    ...
    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\ProductToDepartment", mappedBy="product", cascade={"all"}, orphanRemoval=true)
     * @ORM\JoinColumn(onDelete="CASCADE")
    ...
    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Product\Link", mappedBy="product", cascade={"all"}, orphanRemoval=true)
     * @ORM\JoinColumn(onDelete="CASCADE")
     * @Serializer\Exclude()
     * @Assert\Valid
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Product\Image", mappedBy="product", cascade={"all"}, orphanRemoval=true)
     * @ORM\JoinColumn(onDelete="CASCADE")
     */
    private $images;

    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Product\Document", mappedBy="product", cascade={"all"}, orphanRemoval=true)
     * @ORM\JoinColumn(onDelete="CASCADE")
     */
    private $documents;

    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Product\Variant", mappedBy="product", cascade={"all"}, orphanRemoval=true)
     * @ORM\JoinColumn(onDelete="CASCADE")
    ...
    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Product\Routing", mappedBy="product", cascade={"all"}, orphanRemoval=true)
     * @ORM\JoinColumn(onDelete="CASCADE")
     */
    private $routings;
     ...
     * Add departments
     *
     * @param \ShopIllumination\AdminBundle\Entity\ProductToDepartment $departments
     * @return Product
     */
    public function addDepartment(\ShopIllumination\AdminBundle\Entity\ProductToDepartment $departments)
    {
     ...
     * @param \ShopIllumination\AdminBundle\Entity\ProductToDepartment $departments
     */
    public function removeDepartment(\ShopIllumination\AdminBundle\Entity\ProductToDepartment $departments)
    {
     ...
     * Get description
     *
     * @return \ShopIllumination\AdminBundle\Entity\ProductToDepartment
     */
     ...
     * Add links
     *
     * @param \ShopIllumination\AdminBundle\Entity\Product\Link $link
     * @return Product
     */
    public function addLink(\ShopIllumination\AdminBundle\Entity\Product\Link $link)
    {
     ...
     * Remove links
     *
     * @param \ShopIllumination\AdminBundle\Entity\Product\Link $links
     */
    public function removeLink(\ShopIllumination\AdminBundle\Entity\Product\Link $links)
    {
     ...
     * Add descriptions
     *
     * @param \ShopIllumination\AdminBundle\Entity\Product\Description $descriptions
     * @return Product
     */
    public function addDescription(\ShopIllumination\AdminBundle\Entity\Product\Description $descriptions)
    {
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Product\Description $descriptions
     */
    public function removeDescription(\ShopIllumination\AdminBundle\Entity\Product\Description $descriptions)
    {
     ...
     * Add images
     *
     * @param \ShopIllumination\AdminBundle\Entity\Product\Image $images
     * @return Product
     */
    public function addImage(\ShopIllumination\AdminBundle\Entity\Product\Image $images)
    {
        $this->images[] = $images;
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Product\Image $images
     */
    public function removeImage(\ShopIllumination\AdminBundle\Entity\Product\Image $images)
    {
     ...
     * Add documents
     *
     * @param \ShopIllumination\AdminBundle\Entity\Product\Document $documents
     * @return Product
     */
    public function addDocument(\ShopIllumination\AdminBundle\Entity\Product\Document $documents)
    {
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Product\Document $documents
     */
    public function removeDocument(\ShopIllumination\AdminBundle\Entity\Product\Document $documents)
    {
