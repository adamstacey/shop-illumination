...
/**
 * @ORM\Entity(repositoryClass="ShopIllumination\AdminBundle\Repository\DepartmentRepository")
...
class DepartmentTmp implements DescribableInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\BrandToDepartment", mappedBy="department", cascade={"all"})
     **/
    private $brands;

    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Department\Description", mappedBy="department", cascade={"all"})
     **/
    private $descriptions;

    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\DepartmentToFeature", mappedBy="department", cascade={"all"})
     * @ORM\OrderBy({"displayOrder" = "ASC"})
     **/
    private $features;

    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Department\Image", mappedBy="department", cascade={"all"})
     */
    private $images;

    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Department\Document", mappedBy="department", cascade={"all"})
     */
    private $documents;

    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\Department\Routing", mappedBy="department", cascade={"all"})
     */
    private $routings;
    ...
    /**
     * @Gedmo\TreeParent
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\DepartmentTmp", inversedBy="children")
     * @ORM\JoinColumn(name="parent_id", referencedColumnName="id", onDelete="SET NULL")
     */
    private $parent;

    /**
     * @ORM\OneToMany(targetEntity="ShopIllumination\AdminBundle\Entity\DepartmentTmp", mappedBy="parent")
     * @ORM\OrderBy({"lft" = "ASC"})
     */
    private $children;
     ...
     * Set parent
     *
     * @param \ShopIllumination\AdminBundle\Entity\Department $parent
     * @return Department
     */
    public function setParent(\ShopIllumination\AdminBundle\Entity\DepartmentTmp $parent = null)
    {
        $this->parent = $parent;
     ...
     * Add children
     *
     * @param \ShopIllumination\AdminBundle\Entity\Department $children
     * @return Department
     */
    public function addChildren(\ShopIllumination\AdminBundle\Entity\DepartmentTmp $children)
    {
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Department $children
     */
    public function removeChildren(\ShopIllumination\AdminBundle\Entity\Department $children)
    {
     ...
     * Add brands
     *
     * @param \ShopIllumination\AdminBundle\Entity\BrandToDepartment $brands
     * @return Department
     */
    public function addBrand(\ShopIllumination\AdminBundle\Entity\BrandToDepartment $brands)
    {
        $this->brands[] = $brands;
     ...
     * @param \ShopIllumination\AdminBundle\Entity\BrandToDepartment $brands
     */
    public function removeBrand(\ShopIllumination\AdminBundle\Entity\BrandToDepartment $brands)
    {
     ...
     * Add descriptions
     *
     * @param \ShopIllumination\AdminBundle\Entity\Department\Description $descriptions
     * @return Department
     */
    public function addDescription(\ShopIllumination\AdminBundle\Entity\Department\Description $descriptions)
    {
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Department\Description $descriptions
     */
    public function removeDescription(\ShopIllumination\AdminBundle\Entity\Department\Description $descriptions)
    {
     ...
     * Add features
     *
     * @param \ShopIllumination\AdminBundle\Entity\DepartmentToFeature $features
     * @return Department
     */
    public function addFeature(\ShopIllumination\AdminBundle\Entity\DepartmentToFeature $features)
    {
     ...
     * @param \ShopIllumination\AdminBundle\Entity\DepartmentToFeature $features
     */
    public function removeFeature(\ShopIllumination\AdminBundle\Entity\DepartmentToFeature $features)
    {
     ...
     * Add images
     *
     * @param \ShopIllumination\AdminBundle\Entity\Department\Image $images
     * @return Department
     */
    public function addImage(\ShopIllumination\AdminBundle\Entity\Department\Image $images)
    {
        $this->images[] = $images;
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Department\Image $images
     */
    public function removeImage(\ShopIllumination\AdminBundle\Entity\Department\Image $images)
    {
     ...
     * Add documents
     *
     * @param \ShopIllumination\AdminBundle\Entity\Department\Document $documents
     * @return Department
     */
    public function addDocument(\ShopIllumination\AdminBundle\Entity\Department\Document $documents)
    {
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Department\Document $documents
     */
    public function removeDocument(\ShopIllumination\AdminBundle\Entity\Department\Document $documents)
    {
     ...
     * Add routings
     *
     * @param \ShopIllumination\AdminBundle\Entity\Department\Routing $routings
     * @return Department
     */
     ...
     * @param \ShopIllumination\AdminBundle\Entity\Department\Routing $routings
     */
    public function removeRouting(\ShopIllumination\AdminBundle\Entity\Department\Routing $routings)
    {
