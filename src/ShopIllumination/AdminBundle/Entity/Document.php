 ...
 * @ORM\DiscriminatorMap({"product" = "ShopIllumination\AdminBundle\Entity\Product\Document", "product_variant" = "ShopIllumination\AdminBundle\Entity\Product\Variant\Document", "department" = "ShopIllumination\AdminBundle\Entity\Department\Document", "brand" = "ShopIllumination\AdminBundle\Entity\Brand\Document"})
