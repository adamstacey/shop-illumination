...
class Address
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Contact", inversedBy="addresses")
     */
    private $contact;

    /**
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Contact\AddressType")
     ...
     * Set type
     *
     * @param \ShopIllumination\AdminBundle\Entity\Contact\AddressType $type
     * @return Address
     */
    public function setType(\ShopIllumination\AdminBundle\Entity\Contact\AddressType $type = null)
    {
        $this->type = $type;
     ...
     * Get type
     *
     * @return \ShopIllumination\AdminBundle\Entity\Contact\AddressType
     */
