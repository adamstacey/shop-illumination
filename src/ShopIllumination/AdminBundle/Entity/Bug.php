...
class Bug
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ShopIllumination\AdminBundle\Entity\Contact")
     ...
     * Set ownerContact
     *
     * @param \ShopIllumination\AdminBundle\Entity\Contact $ownerContact
     * @return Bug
     */
    public function setOwnerContact(\ShopIllumination\AdminBundle\Entity\Contact $ownerContact = null)
    {
     ...
     *
     * @param \ShopIllumination\AdminBundle\Entity\Contact $assignedToContact
     * @return Bug
     */
    public function setAssignedToContact(\ShopIllumination\AdminBundle\Entity\Contact $assignedToContact = null)
    {
