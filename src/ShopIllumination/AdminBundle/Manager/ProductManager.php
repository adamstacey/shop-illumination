...
use ShopIllumination\AdminBundle\Entity\Product\Variant\Description as VariantDescription;
use ShopIllumination\AdminBundle\Entity\Product\Description as ProductDescription;
...
use ShopIllumination\AdminBundle\Manager\Templating\ProductTemplateBuilder;
use ShopIllumination\AdminBundle\Manager\Templating\TemplateBuilder;
use ShopIllumination\AdminBundle\Manager\Templating\VariantTemplateBuilder;
use ShopIllumination\AdminBundle\Entity\Product\Variant\Routing as ProductVariantRouting;
...
class ProductManager extends Manager
{
    ...
    private function checkDuplicateUrl(Routing $route, $baseUrl, &$urls=array(), $n=1)
    {
        ...
        $qb->addSelect('r.id')
            ->from('ShopIllumination\AdminBundle\Entity\Routing', 'r')
