...
use ShopIllumination\AdminBundle\Entity\Department\Description as DepartmentDescription;
use ShopIllumination\AdminBundle\Entity\Department\Routing as DepartmentRouting;
...
class DepartmentManager extends Manager
{
    ...
    public function rebuildDepartmentTree()
    {
        ...
        $nodeCount = 1;
        $displayOrder = 1;
        $rootDepartment = $em->createQuery("SELECT d FROM ShopIllumination\AdminBundle\Entity\Department d WHERE d.parent IS NULL")->getSingleResult();
