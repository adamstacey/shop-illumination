<?php
namespace ShopIllumination\AdminBundle\Manager\Templating;
...
class VariantTemplateBuilder extends TemplateBuilder
{
    ...
    function getEntity($object, $alias, $id)
    {
        if ($alias == 'VariantToFeature')
        {
            ...
            $feature = $this->em->getRepository('ShopIllumination\AdminBundle\Entity\Product\Feature')->find($featureId);
