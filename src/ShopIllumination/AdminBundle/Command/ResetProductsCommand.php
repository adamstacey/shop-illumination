...
class ResetProductsCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        // Check the products
        $productDescriptions = $em->getRepository("ShopIllumination\\AdminBundle\\Entity\\Product\\Description")->findBy(array('override' => 1));
        ...
        // Check the variants
        $variantDescriptions = $em->getRepository("ShopIllumination\\AdminBundle\\Entity\\Product\\Variant\\Description")->findBy(array('override' => 1));
