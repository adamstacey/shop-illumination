...
class WarmupIndexCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $solarium = $this->getContainer()->get('solarium.client.si_brickhunter_products_tmp');
        ...
        // Load products
        $query = $em->createQuery('SELECT p FROM ShopIllumination\AdminBundle\Entity\Product p');
