...
use ShopIllumination\AdminBundle\Form\Product\ProductVariantDeliveryType;
use ShopIllumination\AdminBundle\Form\Product\ProductVariantDescriptionsType;
use ShopIllumination\AdminBundle\Form\Product\ProductVariantSeoType;
use ShopIllumination\AdminBundle\Form\Variant\EditVariantDocumentsType;
...
use ShopIllumination\AdminBundle\Form\Variant\EditVariantDescriptionsType;
use ShopIllumination\AdminBundle\Form\Variant\EditVariantDimensionsType;
use ShopIllumination\AdminBundle\Form\Variant\EditVariantFeaturesType;
use ShopIllumination\AdminBundle\Form\Variant\EditVariantImagesType;
use ShopIllumination\AdminBundle\Form\Variant\EditVariantOverviewType;
use ShopIllumination\AdminBundle\Form\Variant\EditVariantPricesType;
...
class VariantController extends Controller {
    ...
    public function newAction(Request $request, $productId)
    {
         ...
         */
        $flow = $this->get('shop_illumination_admin.form.flow.new_variant');
        $flow->bind($variant);
        ...
        return $this->render('ShopIlluminationAdminBundle:Variant:new.html.twig', array(
            'product' => $product,
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $productManger = $this->get('shop_illumination_admin.manager.product');

        /**
         * @var $variant Variant
         */
        $variant = $em->getRepository("ShopIllumination\AdminBundle\Entity\Product\Variant")->find($variantId);
        if(!$variant)
        {
    ...
    {
        return $this->editBaseAction($request, $variantId, 'ShopIlluminationAdminBundle:Variant:edit_overview.html.twig', new EditVariantOverviewType());
    }
    ...
    {
        return $this->editBaseAction($request, $variantId, 'ShopIlluminationAdminBundle:Variant:edit_descriptions.html.twig', new ProductVariantDescriptionsType());
    }
    ...
    {
        return $this->editBaseAction($request, $variantId, 'ShopIlluminationAdminBundle:Variant:edit_seo.html.twig', new ProductVariantSeoType());
    }
    ...
    {
        return $this->editBaseAction($request, $variantId, 'ShopIlluminationAdminBundle:Variant:edit_dimensions.html.twig', new EditVariantDimensionsType());
    }
    ...
    {
        return $this->editBaseAction($request, $variantId, 'ShopIlluminationAdminBundle:Variant:edit_delivery.html.twig', new ProductVariantDeliveryType());
    }
    ...
    public function editPricesAction(Request $request, $variantId)
    {
        ...
        return $this->render('ShopIlluminationAdminBundle:Variant:edit_prices.html.twig', array(
            'variant' => $variant,
            'form' => $form->createView(),
        ));
    }
    ...
    public function editFeaturesAction(Request $request, $variantId)
    {
        ...
        return $this->render('ShopIlluminationAdminBundle:Variant:edit_features.html.twig', array(
            'variant' => $variant,
            'form' => $form->createView(),
        ));
    }
    ...
    public function editImagesAction(Request $request, $variantId)
    {
        ...
        return $this->render('ShopIlluminationAdminBundle:Variant:edit_images.html.twig', array(
            'variant' => $variant,
            'form' => $form->createView(),
        ));
    }
    ...
    public function editDocumentsAction(Request $request, $variantId)
    {
        ...
        return $this->render('ShopIlluminationAdminBundle:Variant:edit_documents.html.twig', array(
            'variant' => $variant,
            'form' => $form->createView(),
        ));
    }
