...
function generateTemplateParts() {
    $("ul.template-part").each(function() {
        ...
        for (var $templatePartCount = 0; $templatePartCount <= $templateParts.length; $templatePartCount++) {
            ...
            if ($templatePartName) {
                var $newTemplatePart = $("<li></li>").html('<img class="actionDeleteParent" src="/bundles/shopilluminationadmin/images/icons/error_small.png" border="0" />'+$templatePartName);
...
$(document).ready(function() {
    ...
    $(document).on("click", ".actionAddTemplatePart", function() {
        ...
        if ($templatePartTypeName != '' && ($templatePartType == '@VariantToFeature' && $templatePartContent != '')) {
            var $newTemplatePart = $("<li></li>").html('<img class="actionDeleteParent" src="/bundles/shopilluminationadmin/images/icons/error_small.png" border="0" />'+$templatePartTypeName);
