    ...
    $("ul.template-part").each(function() {
        ...
        for (var $templatePartCount = 0; $templatePartCount <= $templateParts.length; $templatePartCount++) {
            ...
            if ($templatePartValue) {
                var $newTemplatePart = $("<li></li>").html('<img class="actionDeleteParent" src="/bundles/shopilluminationadmin/images/icons/error_small.png" border="0" />'+$templatePartValue);
...
$(document).ready(function() {
    ...
    $(document).on("click", ".actionAddTemplatePart", function() {
        ...
        if ($templatePartContent != '') {
            var $newTemplatePart = $("<li></li>").html('<img class="actionDeleteParent" src="/bundles/shopilluminationadmin/images/icons/error_small.png" border="0" />'+$templatePartContent);
